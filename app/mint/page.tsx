...
import { useFX } from '@/components/SoundTapticProvider'
...
export default function MintPage(){
  ...
  return (
    <section className="glass p-6">
      ...
      <button onClick={next} className="mt-6 px-4 py-2 rounded-xl border border-gold/40 hover:bg-white/5">Advance</button>
      <div className="text-xs text-slate-400 mt-2">Connect contract on Sepolia to make it real.</div>
    </section>
  )
}
